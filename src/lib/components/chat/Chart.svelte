<script lang="ts">
	...
	import type { ChartContent } from '$lib/types/chat';

	type Props = Omit<ChartContent, 'type'>;

	let { chartType, title, data, series, mode }: Props = $props();
</script>

<div class="chart-wrap">
	{#if chartType === 'bar'}
		<BarChart {data} {series} {title} {mode} />
