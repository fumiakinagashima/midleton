// Generates a SQL file of demo data to load into production D1 (wrangler d1 execute --remote).
// Usage:
...
const lines: string[] = [
	'-- SQL for loading demo data (generated by `bun run scripts/generate-seed-sql.ts`, do not commit)',
...
console.log(
	`Done: ${data.customers.length} customers / ${data.contacts.length} contacts / ${data.deals.length} deals → ${outFile}`
);
console.log('');
console.log('To load into production D1:');
